...
const (
	...
	BookingService_UpdateRide_FullMethodName    = "/BookingService/UpdateRide"
)
...
type BookingServiceClient interface {
	...
	UpdateRide(ctx context.Context, in *RideRequest, opts ...grpc.CallOption) (*RideResponse, error)
}
...
func (c *bookingServiceClient) UpdateRide(ctx context.Context, in *RideRequest, opts ...grpc.CallOption) (*RideResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RideResponse)
	err := c.cc.Invoke(ctx, BookingService_UpdateRide_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookingServiceServer interface {
	...
	UpdateRide(context.Context, *RideRequest) (*RideResponse, error)
...
func (UnimplementedBookingServiceServer) UpdateRide(context.Context, *RideRequest) (*RideResponse, error) {
...
func _BookingService_UpdateRide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RideRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).UpdateRide(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_UpdateRide_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).UpdateRide(ctx, req.(*RideRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookingService_UpdateRide_Handler,
		},
	},
